...
////// [MACROS] //////
// This macro will return whether the sprite has ended or not
// It's best to set your sprite speed mode to Frames Per Game Frame, as any lag may skip the last frame, which means the animation will re-play
